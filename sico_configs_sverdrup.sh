...
export NETCDFHOME=/opt/ohpc/pub/libs/gnu/openmpi/netcdf-fortran/4.4.4
...
if [ "$LIS_FLAG" = "true" ] ; then
   LISHOME=/home/shreyas/lis-2.0.30/installation
...
#   FCFLAGS=${FCFLAGS}' '${NETCDF_FLAGS}' '${NETCDF_LIBS}
   ...
   # Manual settings
#   echo "Flags3: $FCFLAGS"
FCFLAGS=${FCFLAGS}' -I'${NETCDFINCLUDE}' -L'${NETCDFLIB}' -lnetcdff'
#fi
